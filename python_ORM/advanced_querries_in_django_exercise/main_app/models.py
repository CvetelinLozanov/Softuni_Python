...
class Task(models.Model):
    ...
    def ongoing_high_priority_tasks(cls):
        return cls.objects.filter(is_completed=False, priority='High', completion_date__gt=F('creation_date'))
    ...
    def recent_completed_tasks(cls, days: int):
        target_date = F('creation_date') - timedelta(days=days)
        return cls.objects.filter(is_completed=True, completion_date__gte=target_date)
