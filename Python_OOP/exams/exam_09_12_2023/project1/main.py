...
print(nautical_catch_challenge.dive_into_competition("ScubaDiver", "JamalCarter"))
...
print(nautical_catch_challenge.chase_fish("JamalCarter", "BluestripeSnapper", False))
print(nautical_catch_challenge.chase_fish("JamalCarter", "SwordFish", False))
print(nautical_catch_challenge.chase_fish("JamalCarter", "BluestripeSnapper", False))
print(nautical_catch_challenge.chase_fish("JamalCarter", "BluestripeSnapper", False))
